<?php
$liste_medecins = get_liste_medecins();
?>
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb" class="w-50 d-flex justify-content-end">
            ...
            <li class="breadcrumb-item"><i class="fas fa-fw fa-user-check"></i><a href="?requette=liste-medecin">Liste des médecins</a></li>
            </ol>
        </nav>
    </div>
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            ...
            <div class="col-md-6 text-end">
                <a href="?requette=ajout-medecin" class="btn btn-success">Ajouter un médecin</a>
            </div>
                ...
                <div>
                    ...
                    <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                        ...
                        <div class="row mt-5">
                            ...
                            <?php if ((isset($liste_medecins) && !empty($liste_medecins))) {
                                ...
                                <thead>
                                <tr role="row">
                                    <th scope="col" class="col-2 text-center">Matricule</th>
                                    <th scope="col" class="col-2 text-center">Nom</th>
                                    <th scope="col" class="col-2 text-center">Spécialité</th>
                                </tr>
                                </thead>
                                <tbody>
                                <?php
                                ...
                                foreach ($liste_medecins as $medecin) {
                                    ?>
                                    <tr class="odd">
                                        <td  scope="row"  class="text-center"><?= $medecin["matmed"]; ?></td>
                                        <td class="text-center sorting_1"><?= $medecin["nommedecin"]; ?></td>
                                        <td class="text-center sorting_1"><?= $medecin["specialite"]; ?></td>
                                    </tr>
