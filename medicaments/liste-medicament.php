...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb" class="w-50 d-flex justify-content-end">
            ...
            <li class="breadcrumb-item"><i class="fas fa-fw fa-user-check"></i><a href="?requette=liste-medicament">Liste des médicaments</a></li>
            </ol>
        </nav>
    </div>
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            ...
            <div class="col-md-6 text-end">
                <a href="?requette=ajout-medicament" class="btn btn-success">Ajouter un médicament</a>
            </div>
                        ...
                        <div class="row mt-5">
                            ...
                            <?php if ((isset($liste_medicaments) && !empty($liste_medicaments))) {
                                ...
                                foreach ($liste_medicaments as $medicament) {
                                    ?>
                                    <tr class="odd">
                                        <td  scope="row"  class="text-center"><?= $medicament["nummed"]; ?></td>
                                        <td class="text-center sorting_1"><?= $medicament["nommed"]; ?></td>
                                    </tr>
                            ...
                            <?php
                                ...
                                echo "Aucun médicament n'a été trouvé.";
