...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb" class="w-50 d-flex justify-content-end">
            ...
            <li class="breadcrumb-item"><i class="fas fa-fw fa-user-check"></i><a href="?requette=liste-soin">Liste des soins</a></li>
            </ol>
        </nav>
    </div>
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            ...
            <div class="col-md-6 text-end">
                <a href="?requette=ajout-soin" class="btn btn-success">Ajouter un soin</a>
            </div>
                ...
                <div>
                    ...
                    <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                        ...
                        <div class="row mt-5">
                            ...
                            <?php if ((isset($liste_soins) && !empty($liste_soins))) {
                                ...
                                <tr role="row">
                                    ...
                                    <th scope="col" class="col-2 text-center">Libellé</th>
                                    <th scope="col" class="col-2 text-center">Coût (en F CFA)</th>
                                </tr>
                                </thead>
                                <tbody>
                                <?php

                                foreach ($liste_soins as $soin) {
                                    ?>
                                    <tr class="odd">
                                        <td  scope="row"  class="text-center"><?= $soin["codsoin"]; ?></td>
                                        <td class="text-center sorting_1"><?= $soin["libsoin"]; ?></td>
                                        <td class="text-center sorting_1"><?= $soin["coutsoin"]; ?></td>
                                    </tr>
                            ...
                            <?php
                                ...
                                echo "Aucun soin n'a été trouvé.";
