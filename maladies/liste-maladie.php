<?php
$liste_maladies = get_liste_maladies();
?>
                ...
                <div>
                    ...
                    <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                        ...
                        <div class="row mt-5">
                            ...
                            <?php if ((isset($liste_maladies) && !empty($liste_maladies))) {
                                ...
                                foreach ($liste_maladies as $maladie) {
                                    ?>
                                    <tr class="odd">
                                        <td  scope="row"  class="text-center"><?= $maladie["nummal"]; ?></td>
                                        <td class="text-center sorting_1"><?= $maladie["nommal"]; ?></td>
                                    </tr>
